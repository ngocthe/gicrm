<template>
  <ListScreenComponent>
    <template #head>
      <Head>
        <Title
          >{{ $t("site_name_title") }}{{ $t("title_screen.notices") }}</Title
        >
      </Head>
    </template>
    <template #header-content>
      <CommonHeaderContentComponent>
        <template #title>{{ $t("title_screen.notices") }}</template>
      </CommonHeaderContentComponent>
    </template>
    <template #content>
      <div v-loading="isLoadingTable" class="notice-list-container">
        <div
        ...
        >
          ...
          <el-form
            class="data-form div-search d-flex align-items-center"
            :model="formSearch"
            ...
            >
              <template #title>
                <div class="box-notice__list align-items-center">
                  ...
                  <div v-if="item.creator_image" class="notice-item__left">
                    <el-image :src="item.creator_image" fit="cover" />
                  </div>
              ...
              <div class="notice-content">
                <component
                  :is="checkTemplateNotice(item.code)"
                  :user-name="getFullName(item.first_name, item.last_name)"
                  :booking-number="item.referer?.reservation_code"
...
import NoticeRequest from "../../../shared/requests/NoticeRequest";

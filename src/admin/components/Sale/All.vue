      ...
      >
        ...
        >
          <template #default="scope">
            <span v-if="scope.row.type === REVENUE.SUBSCRIPTION">
              {{
                scope.row.subscription_fee !== null
                  ? priceDisplay(scope.row.subscription_fee) + $t("yen")
                  : ""
              }}
            </span>
            <span v-else>
        ...
        >
          <template #default="scope">
            <span v-if="scope.row.type === REVENUE.SUBSCRIPTION"> - </span>
            <span v-else>
              {{
                scope.row.fee !== null
        ...
        >
          <template #default="scope">
            <span v-if="scope.row.type === REVENUE.CANCELLATION">
              {{
                scope.row.remain !== null
                  ? priceDisplay(scope.row.remain) + $t("yen")
                  : ""
              }}
            </span>
            <span v-else> - </span>
        ...
        >
          <template #default="scope">
            <span v-if="mode === REVENUE.ALL || !mode">

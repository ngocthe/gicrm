<template>
  ...
  <div v-else class="body-notice">
    ...
    <p>
      {{ $t("template_notice.accepted_your_reservation") }}
    </p>
    <br />
    ...
    <p>{{ $t("template_notice.reservation_completion_email") }}</p>
    <br />
    <p>{{ $t("template_notice.confirmation_and_approval") }}</p>
    <p>{{ $t("template_notice.confirmation_is_completed") }}</p>
  </div>
</template>
